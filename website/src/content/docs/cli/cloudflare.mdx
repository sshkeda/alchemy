...
| Option                 | Description                                                                                                                          |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| `--profile <name>`     | Alchemy auth profile (defaults to `$ALCHEMY_PROFILE` or the stored default). Determines which `~/.alchemy/profiles.json` entry is used.                  |
...
| `--profile <name>`     | Alchemy auth profile (defaults to `$ALCHEMY_PROFILE` or the stored default)                                    |
| `--env-file <path>`    | Load environment variables from a file                                                                        |
