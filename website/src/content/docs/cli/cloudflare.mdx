...
| Option                 | Description                                                                                                                          |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| `--profile <name>`     | Alchemy auth profile (defaults to `$ALCHEMY_PROFILE`, the stored default, or `default`). Determines which `~/.alchemy/profiles.json` entry is used.       |
...
| `--profile <name>`     | Alchemy auth profile (defaults to `$ALCHEMY_PROFILE`, the stored default, or `default`)                                           |
| `--env-file <path>`    | Load environment variables from a file                                                                        |
