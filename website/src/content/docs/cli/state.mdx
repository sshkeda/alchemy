...
open the **state explorer**. It shows stacks, stages, resources, and the
persisted state of the selected resource. Mark
...
| `--profile <name>`  | Auth profile to use (defaults to `$ALCHEMY_PROFILE` or the stored default)                                                                        |
