...
explorer. It is a browsable tree of stacks, stages, and resources. This is
the record used by the next plan, not the live cloud. See
[State Store](/state-store)). Full flag reference:
[state](/cli/state).
